<?php require_once("core/tpl/cabecalho.tpl.php"); ?>
		...
		<h1 class="text-center">Quer conferir se existem Permutz que combinam com você?</h1><br>
		<form class="" id="form-combinator" name="form-combinator" method="post" action="perfil-script.php">
			
			<!-- dados de contato -->
			<fieldset>
				<legend>Informe abaixo seu e-mail</legend>
				...
				<input type="submit" class="btn btn-primary btn-lg btn-block" id="" name="combinator-form-submit" value="Enviar">
			</fieldset>
		</form>
